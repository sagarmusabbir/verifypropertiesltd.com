...
import { PiHouse, PiHouseLineFill } from "react-icons/pi";
        ...
        <div className="space-y-8 md:grid md:grid-cols-2 md:gap-8 md:space-y-0 lg:grid-cols-3 xl:grid-cols-4 xl:gap-8">
          <Card className="dark:border-0">
            <div className="flex h-10 w-10 items-center justify-center rounded bg-gray-100 dark:bg-gray-900 lg:h-12 lg:w-12">
              <PiHouseLineFill className="h-5 w-5 text-primary-600 dark:text-primary-500 lg:h-6 lg:w-6" />
            </div>
            <h3 className="text-xl font-bold dark:text-white">Letting</h3>
            <p className="text-gray-500 dark:text-gray-400">
              Discover seamless property letting with our dedicated service,
              ensuring you find the perfect tenants quickly and effortlessly.
              {/* We
