      ...
      <div className="mx-auto max-w-screen-xl px-4 py-8 text-center sm:py-16 lg:px-6">
        ...
        <div className="mt-8 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:mt-12 lg:grid-cols-3">
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Data</h3>
            <p className="mb-4 text-gray-500 dark:text-gray-400">
              We already have access to a huge set of data to search and verify
            </p>
            <a
              href="#"
          ...
          <div>
            ...
            <p className="mb-4 text-gray-500 dark:text-gray-400">
              We maintain property insurance and all GBP cash balances are
              covered.
            </p>
            <a
              href="#"
          ...
          <div>
            ...
            <h3 className="mb-2 text-xl font-bold dark:text-white">Listing</h3>
            <p className="mb-4 text-gray-500 dark:text-gray-400">
              Our marketplace supports a variety of the most popular listing.
            </p>
            <a
              href="#"
              className="inline-flex items-center text-sm font-medium text-primary-600 hover:text-primary-700 dark:text-primary-500 dark:hover:text-primary-400"
